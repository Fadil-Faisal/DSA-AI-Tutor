...
const QUESTIONS: Question[] = [
  {
    ...
    options: ['function myFunc():', 'def myFunc():', 'fn myFunc():', 'void myFunc():'],
    correctIndex: 1,
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation: 'A Dictionary (dict) stores data values in key:value pairs and is highly optimized for fast lookups.',
  },
  {
    id: 3,
    triggerAt: 110,
    question: 'What is the correct way to check if a key exists in a dictionary?',
    options: ['dict.has(key)', 'dict.contains(key)', 'key exists dict', 'key in dict'],
    correctIndex: 3,
    explanation: 'The `in` operator is the standard, most readable way to check for key existence in a Python dictionary (O(1) time).',
  },
];
